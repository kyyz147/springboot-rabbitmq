 ...
 * */
@RabbitListener(queues="queue005")  //监听这个队列,有消息就会发过来,项目启动就开始监听
public class MessageReceiver5 {
	@RabbitHandler
	public void process(String hello,Channel channel,Message message) throws IOException{
		...
		try {
			...
			System.out.println("接收者55 receiver success"+ hello);
		} catch (Exception e) {
			e.printStackTrace();
			/*丢弃这条消息*/
			channel.basicNack(message.getMessageProperties().getDeliveryTag(), false, false);
			System.out.println("接收者55 receiver fail");
		}
